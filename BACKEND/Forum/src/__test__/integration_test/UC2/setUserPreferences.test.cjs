...
describe("Set User Preferences (Final Stage)", () => {
  beforeAll(async () => {
  ...
  async function createUserAndToken() {
    ...
    const username = `testuser_uc2_${uniqueId}`;
    const email = `testuser_uc2_${uniqueId}@test.com`;
    ...
    test("should set all user preferences successfully", async () => {
